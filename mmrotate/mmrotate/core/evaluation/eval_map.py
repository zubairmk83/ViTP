...
def eval_rbbox_map(det_results,
    ...
    elif isinstance(iou_thr, list):
        return(eval_rbbox_maps_(det_results,
                   annotations,
                   scale_ranges=scale_ranges,
                   iou_thr=iou_thr,
                   use_07_metric=use_07_metric,
...
def eval_rbbox_map_(det_results,
                   annotations,
                   scale_ranges=None,
                   iou_thr=0.5,
                   use_07_metric=True,
...
def eval_rbbox_maps_(det_results,
                   annotations,
                   scale_ranges=None,
...
def print_map_summary_(mean_ap_50,
                      mean_ap_75,
                      mAP50eval_results,
                      mAP75eval_results,
                      dataset=None,
