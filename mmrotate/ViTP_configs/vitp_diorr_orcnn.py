...
data = dict(
    ...
    train=dict(
        type='DIORRDataset',
        ann_file=[
            'data/DIOR/ImageSets/train.txt',
            'data/DIOR/ImageSets/val.txt'
        ],
        ann_subdir=
        'data/DIOR/Annotations/Oriented Bounding Boxes/',
        img_subdir=
    ...
    val=dict(
        type='DIORRDataset',
        ann_file='data/DIOR/ImageSets/test.txt',
        ann_subdir=
        'data/DIOR/Annotations/Oriented Bounding Boxes/',
        img_subdir='data/DIOR/JPEGImages/test/',
        img_prefix='data/DIOR/JPEGImages/test/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
...
work_dir = './work_dirs/vitp_diorr_orcnn'
auto_resume = False
gpu_ids = range(0, 8)
device = 'cuda'
