...
data = dict(
    ...
    train=dict(
        type='SARDet_hbb',
        ann_file=
        'data/SARDet_100K/Annotations/train.json',
        img_prefix=
        'data/SARDet_100K/JPEGImages/train/',
        pipeline=[
    ...
    val=dict(
        type='SARDet_hbb',
        ann_file=
        'data/SARDet_100K/Annotations/test.json',
        img_prefix=
        'data/SARDet_100K/JPEGImages/test/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
...
work_dir = './work_dirs/vitp_sardet100k_cascade_rcnn'
auto_resume = True
gpu_ids = range(0, 8)
device = 'cuda'
