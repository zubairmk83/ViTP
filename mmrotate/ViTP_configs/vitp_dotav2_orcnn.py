...
data = dict(
    ...
    train=dict(
        type='DOTAv2Dataset',
        ann_file=
        'data/dota_v2/split_ss_dota/trainval/annfiles/',
        img_prefix=
        'data/dota_v2/split_ss_dota/trainval/images/',
        pipeline=[
    ...
    val=dict(
        type='DOTAv2Dataset',
        ann_file=
        'data/dota_v2/split_ss_dota/val/annfiles/',
        img_prefix=
        'data/dota_v2/split_ss_dota/val/images/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
    ...
    test=dict(
        type='DOTAv2Dataset',
        ann_file=
        'data/dota_v2/split_ss_dota/test/images/',
        img_prefix=
        'data/dota_v2/split_ss_dota/test/images/',
        pipeline=[
            dict(type='LoadImageFromFile'),
